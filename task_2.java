...
public void checkIsAdultWhenAgeIs18True() {
    ...
    assertEquals("Должно врнуться true, так как пользователю ровно 18",true,isAdult);
}
...
public void checkIsAdultWhenAgeIsLessThan18False() {
    ...
    assertEquals("Должно врнуться false, так как пользователь несовершеннолетний",false,isAdult);
}
